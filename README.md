...
Without a clear vision of what the homelab is going to look like, building is like driving with eyes closed. So I tried to design my own infrastructure first, and by clicking the link below you can see the [Logical Network Diagram](Diagrams/logical%20network%20diagram.drawio.svg). 

In addition, I created a rough overview of all the steps I have already taken or plan to make. The order is just a tendency - the list helps me to keep track of my 
